# Final non-data augmented MobileNetV2 model - train and validation script
...
lr = 1e-4
SEEDS = [42, 123, 777]
MODEL_SAVE_TPL = "mobilenetv2_base_seed{seed}.pth"
...
train_transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485,0.456,0.406], std=[0.229,0.224,0.225]),  # ImageNet std/mean
])
